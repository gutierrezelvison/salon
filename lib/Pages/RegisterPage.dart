...
import '../Widgets/Components/WidgetRegister.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: isMobileAndTablet(context)
          ? ShopAppBar(_opacity,'RegisterPage') : Header('RegisterPage',_opacity,autoScrollController,CartState().getCartData().length),
