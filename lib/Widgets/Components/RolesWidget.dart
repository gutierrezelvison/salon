...
class _RolesWidgetState extends State<RolesWidget> {
  ...
  void _saveForm() async {
    ...
    if (isValid) {
        if (edit) {
          if (await bdConnection.updateRol(context: context,id: idSucursal,name: _localNameController.text.toLowerCase(),
          display_name: _localNameController.text, description: _localDescriptionController.text)) {
            limpiar();
            CustomSnackBar().show(
                context: context,
          ...
          if (await bdConnection.setRol(context: context,name: _localNameController.text.toLowerCase(),
              display_name: _localNameController.text, description: _localDescriptionController.text)) {
            limpiar();
            CustomSnackBar().show(
                context: context,
  ...
  limpiar(){
    setState(() {
      ...
      _localDescriptionController.text = '';
      edit=false;
      idSucursal=0;
    });
  }
  ...
  deleteItem(int id)async{
    if(await bdConnection.deleteRol(context: context,id: id)){
      setState(() {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(pageIndex==0?"Roles":edit?"Modificar Rol":"Añadir Rol",
  ...
  Widget sucursales(){
    return FutureBuilder(
        future: bdConnection.getRoles(context),
    ...
    return ListTile(
        title: Row(
          ...
          children: [
                  ...
                  InkWell(
                    onTap: (){
                      setState(() {
                        ...
                        _localNameController.text=snapshot.data[index].display_name;
                        _localDescriptionController.text=snapshot.data[index].description;
                      });
                    },
                    child: Container(
                      padding: responsiveApp.edgeInsetsApp.allSmallEdgeInsets,
            ...
            SizedBox(width: responsiveApp.setWidth(40),
              child: snapshot.data[index].id>2?Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  InkWell(
                    onTap: (){
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Descripción del rol*'),
                Row(
                  children: [
                    Expanded(
                      child: TextFormField(
